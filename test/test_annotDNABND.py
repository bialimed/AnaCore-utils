...
from annotDNABND import annotGeneShard, annotModelRetIntron, exonsPos, getDistBeforeCDSForward, getDistBeforeCDSReverse, getGeneAnnot, getMostSupported, selectedPos, shardIsBeforeBND
# todo: annot
...
2	simulation	exon	150	200	.	-	.	gene_id "GENE_I03"; transcript_id "TR_05"; exon_number "1"; gene_name "GENE_N03";""")
    ...
    def test_getGeneAnnot(self):
        ...
        print(record.info)
        print(getGeneAnnot(record, genes_by_chr))
        self.assertEqual(
            sorted(getGeneAnnot(record, genes_by_chr), key=lambda elt: elt["Feature"]),
            [
                {
